          ...
          <div className="xl:w-6/12 md:w-5/12 md:pl-3 cadre">
            <div className="grid xl:grid-cols-2 xl:grid-rows-2 xl:gap-x-4 md:gap-x-6">
              <div className="mb-1 md:mb-12">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="p-2 rounded-md w-14 h-14 flex items-center justify-center bg-white">
              ...
              <div className="mb-1 md:mb-12">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="p-4 rounded-md w-14 h-14 flex items-center justify-center bg-white">
              ...
              <div className="mb-4 md:mb-4">
                <div className="flex align-start">
                  ...
                  <div>
                    <h3 className="font-bold mb-1">Temps de travail</h3>
