          ...
          <div className="card">
            <div className="card-body mt-5">
              <div className="card-body col-sm-6 mt-5 filcard">
                ...
                <h3>
                  <span>livré efficacement</span>
                </h3>
                <p>
                  Diffusion de routine et urgente de newsletters, de mises à
                  jour d'événements, de diffusions d'urgence, d'alertes de temps
                  d'arrêt et bien plus encore.
                </p>
